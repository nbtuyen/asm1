    ...
    <div class="container">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                ...
                <img src="<?= IMG_URL . 'banner1.png' ?>" alt="">
                <div class="text">HỌC, HỌC NỮA, HỌC MÃI</div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">2 / 3</div>
                <img src="<?= IMG_URL . 'banner2.png' ?>" alt="">
                <div class="text">Học không biết chán, dạy người không biết mỏi.</div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">3 / 3</div>
                <img src="<?= IMG_URL . 'banner3.jpg' ?>" alt="">
                <div class="text"> Học… học để là chính mình, và học để từ bỏ với vẻ thanh cao những gì không phải là mình.</div>
            </div>
    ...
    <div id="myLinks" style="display: none">
        ...
        ?>
            <?php if ($_SESSION['auth']['role_id'] == 1) : ?>
                <a href="<?= BASE_URL . 'dashboard/mon-hoc' ?>"><i class="fas fa-user"></i>Trang Quản Trị</a>
            <?php endif; ?>
            <a href="<?= BASE_URL . 'tai-khoan/cap-nhat/' . $_SESSION['auth']['id'] ?>"><i class="fas fa-user"></i>Cập Nhật Tài Khoản</a>
